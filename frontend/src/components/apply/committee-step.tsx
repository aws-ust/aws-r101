...
export function CommitteeStep({ values, onChange, errors }: CommitteeStepProps) {
  ...
  function applyChoice(
    ...
    const firstTitle =
      rank === 1 ? nextTitle : values.firstPositionTitle
    const secondTitle =
      rank === 2 ? nextTitle : values.secondPositionTitle
    ...
    if (!needsDevelopmentGithub(firstCommittee, secondCommittee, firstTitle, secondTitle)) {
      patch.githubUrl = ""
    }
    onChange(patch)
  }
