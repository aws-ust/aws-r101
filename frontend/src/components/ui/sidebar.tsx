    ...
    >
      ...
      >
        <div
          ...
          className="cn-sidebar-inner glass flex size-full flex-col border-blue-chalk/15 bg-haiti/75"
        >
          {children}
        </div>
      </div>
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      size="icon-sm"
      className={cn(
        "cn-sidebar-trigger border-transparent bg-transparent text-blue-chalk shadow-none hover:bg-meteorite/50 hover:text-aquamarine before:hidden",
        className
      )}
      onClick={(event) => {
        onClick?.(event)
