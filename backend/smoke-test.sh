...
request POST /uploads/presign '{"documents":[{"documentType":"resume","fileName":"resume.txt","sizeBytes":1,"checksumSha256":"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="},{"documentType":"registration","fileName":"registration.pdf","sizeBytes":10000001,"checksumSha256":"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="}]}'
